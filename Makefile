...
$(BUILDDIR)/libcosmoSPHere.a: $(BUILDDIR)/density_base.o $(BUILDDIR)/tree.o $(BUILDDIR)/force.o $(BUILDDIR)/gpu_state.o $(BUILDDIR)/dens_c_api.o $(BUILDDIR)/force_c_api.o $(BUILDDIR)/gpu_force_template.o
	ar rcs $@ $^

$(BUILDDIR)/gpu_force_template.o: src/gpu_force_template.cu $(TAGFILE)
	$(GPUCC) $(GPU_FLAGS) -MMD -MP -MF $(BUILDDIR)/gpu_force_template.d -c -o $@ $<
